...
@Controller
public class SwaggerApiDocLoaderController implements Handler<RoutingContext> {


    @Autowired
    public SwaggerApiDocLoaderController(Router router) {
        router.get("/api-doc").handler(this);
    }
