...
@Controller
public class Load404PageController implements Handler<RoutingContext> {


    @Autowired
    public Load404PageController(Router router) {
        router.get("/image_404.png").handler(this);
    }

    @Override
    public void handle(RoutingContext ctx) {
        ctx.response().setStatusCode(200)
                .putHeader(ConfigData.CONTENT_TYPE, "image/png")
                .sendFile("image/img.png");
    }
