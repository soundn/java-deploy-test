...
@Controller
public class BitCoinAssetController implements Handler<RoutingContext> {


    @Autowired
    public BitCoinAssetController(Router router) {
        router.get("/bit_coin.png").handler(this);
    }
    ...
    public void handle(RoutingContext ctx) {
        ctx.response().setStatusCode(200)
                ...
                .sendFile("coinimages/bitcoin.png");
    }
