...
@Controller
public class LightCoinAssetController implements Handler<RoutingContext> {


    @Autowired
    public LightCoinAssetController(Router router) {
        router.get("/light_coin.png").handler(this);
    }
    ...
    public void handle(RoutingContext ctx) {
        ctx.response().setStatusCode(200)
                ...
                .sendFile("coinimages/lightcoin.png");
    }
