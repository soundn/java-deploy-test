...
@Controller
public class EthCoinAssetController implements Handler<RoutingContext> {


    @Autowired
    public EthCoinAssetController(Router router) {
        router.get("/eth_coin.png").handler(this);
    }
    ...
    public void handle(RoutingContext ctx) {
        ctx.response().setStatusCode(200)
                ...
                .sendFile("coinimages/ethcoin.png");
    }
