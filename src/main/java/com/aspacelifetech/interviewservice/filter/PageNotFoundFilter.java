...
@Controller
public class PageNotFoundFilter implements Handler<RoutingContext> {

    @Autowired
    public PageNotFoundFilter(Router router) {
    ...
    public void handle(RoutingContext rc) {
        rc.response().setStatusCode(200)
                .putHeader(ConfigData.CONTENT_TYPE, "text/html")
                .sendFile("html/resource-not-found.html");
    }
